  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "LUNÉ",
          style: AppStyles.style36Regular,
          // .copyWith(
        ...
        actions: [
          IconButton(
            onPressed: () {},
            icon: SvgPicture.asset("assets/icons/Button - Shopping bag.svg"),
          ),
        ],
      ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  height: 156,
                  child: Text(
                    """A legacy of light, sculpted into form. Every
...
craftsmanship with contemporary design to
     create heirlooms for the modern era.""",
